...
cc_dat %>%
  select(MET_mod_bin, MET_vig_bin, MET_MVPA_bin, num_day_mod_bin, num_day_vig_bin, num_day_walk_bin) %>%
...
```
```{r }
ggplot(cc_dat, aes(x = num_day_mod_bin)) +
  geom_bar(fill = "lightblue", color = "black") +
  labs(
    title = "Undertakes mod activity",
    x = "Yes/No",
    y = "Count"
  ) +
  theme_minimal() 
...
####Other binary
 binary exposure
```{r}
binary_exposures <- c("MET_mod_bin", "MET_vig_bin", "MET_MVPA_bin", "num_day_mod_bin", "num_day_vig_bin", "num_day_walk_bin")
...
result <- log_transform_plot(cc_dat, vars = c("MET_mod", "MET_vig", "MET_MVPA", "MET_walk"))
...
exposures <- tibble::tibble(
  bin_var = c("MET_mod_bin", "MET_vig_bin", "MET_MVPA_bin",
              "num_day_mod_bin", "num_day_vig_bin"),
  met_var = c("MET_mod", "MET_vig", "MET_MVPA",
              "num_days_mod_PA", "num_days_vig_PA"),
  label   = c("Moderate", "Vigorous", "Total MVPA",
              "Does moderate activity", "Does vigorous activity")
)
